...
/** Money left an account. Carries the resulting balance so a consumer never has to reconstruct it. */
public final class AccountDebited extends AbstractDomainEvent {

    public static final String EVENT_TYPE = "account.debited";

    private final AccountId accountId;
    private final Money amount;
    private final Money balanceAfter;

    private AccountDebited(Builder builder) {
        super(builder);
